...
export const dictionary: MarketingDictionary = {
  ...
  compare: {
    ...
    infoAmountBody:
      "서양 별자리는 태어난 '월'만으로 정해지는 값 하나예요 — 예를 들어 3월에 태어났다면 평생 물고기자리 하나죠. 사주는 태어난 년·월·일·시 네 가지를 각각 하나의 '기둥'으로 세워요. 그래서 같은 달, 심지어 같은 날에 태어났더라도 시간이 다르면 사주 전체가 달라질 수 있어요 — 별자리보다 훨씬 세밀하게 개인화된 조합인 셈이에요.",
    ...
    philosophyBody:
      '별자리든 사주든, 성향과 흐름을 돌아보는 하나의 렌즈일 뿐 앞날을 확정하는 게 아니에요. 사주편지의 매일 편지도 이 원칙을 지켜요 — 단정적인 예언이 아니라, 부드럽게 힘을 실어주는 한마디를 목표로 해요.',
    referenceTitle: '참고 자료: 별자리·일간 대응표',
    ctaText: '내 사주 한 줄 미리보기, 무료로 받아보기',
  },
  leadCapture: {
